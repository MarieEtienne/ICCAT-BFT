...
13	-5	30	1	0	-5	30 	#log_ro/msy 
0.92	0.2	1	4	3	3	2 	#steepness h 
-1.47	-5	0	-1	1	-1.469	0.05 	#log_m, natural mortality
12.5	-5	20	1	0	-5	20 	#log_Rbar, average recruitment
12.5	-5	20	1	0	-5	20 	#log_Rinit, initial recruitment
0.4	0.001	0.999	1	3	2.5	2.5 	#proportion of variance for observation process
0.8	0.001	12	3	4	2.5	0.8 	# total variance
...
0	0	0	0	0	0	0 	# 5  -No. of year nodes for 2d spline(0=ignore)
2	2	2	-1	2	2	2 	# 6  -Phase of estimation (-1 for fixed)
5	5	5	5	5	5	5 	# 7  -Penalty wt for 2nd differences w=1/(2*sig^2)
0	0	0	0	0	0	0 	# 8  -Penalty wt for dome-shaped w=1/(2*sig^2)
0	0	0	0	0	0	0 	# 9  -Penalty wt for time-varying selectivity
1	1	1	1	1	1	1 	# 10 -n_sel_blocks (number of selex blocks)
## ------------------------------------------------------------------------- ##
1950
1950
1950
...
##			2 - random walk in q                                            ##
## ------------------------------------------------------------------------- ##
6 	# -number of surveys (nits)
0	0	0	0	0	0 	# -prior type (see legend above)
0	0	0	0	0	0 	# -prior log(mean)
0	0	0	0	0	0 	# -prior sd
## ------------------------------------------------------------------------- ##
##
## ------------------------------------------------------------------------- ##
