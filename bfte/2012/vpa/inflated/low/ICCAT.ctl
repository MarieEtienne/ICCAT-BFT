...
5	-5	30	1	0	-5	15 	#log_Rbar, average recruitment
4	-5	30	1	0	-5	15 	#log_Rinit, initial recruitment
0.3	0.001	0.999	3	3	12	52.8 	#proportion of variance for observation process
1	0.001	10	3	4	1e-04	1e-04 	# total variance
...
## ------------------------------------------------------------------------- ##
3	3	3	6	3	3	3	3 	# 1  -selectivity type ivector(isel_type) for gear
6	6	6	9.9	6	6	6	6 	# 2  -Age/length at 50% selectivity (logistic)
2	2	2	0.11	2	2	2	2 	# 3  -STD at 50% selectivity (logistic)
3	3	3	0	3	3	3	3 	# 4  -No. of age nodes for each gear (0=ignore)
0	0	0	0	0	0	0	0 	# 5  -No. of year nodes for 2d spline(0=ignore)
2	2	2	-1	2	2	2	2 	# 6  -Phase of estimation (-1 for fixed)
15	15	15	15	15	15	15	15 	# 7  -Penalty wt for 2nd differences w=1/(2*sig^2)
50	50	50	50	50	50	50	50 	# 8  -Penalty wt for dome-shaped w=1/(2*sig^2)
1	1	1	1	1	1	1	1 	# 9  -Penalty wt for time-varying selectivity
...
0	0	0	0	0	0	0 	# -prior type (see legend above)
0	0	0	0	0	0	0 	# -prior log(mean)
0	0	0	0	0	0	0 	# -prior sd
## ------------------------------------------------------------------------- ##
##
## ------------------------------------------------------------------------- ##
...
## ------------------------------------------------------------------------- ##
	...
	153.392349206349	# 3  -std in observed catches in first phase.
	76.6961746031746	# 4  -std in observed catches in last phase.
