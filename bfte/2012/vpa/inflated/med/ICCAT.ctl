...
0.6         -7.0    15       4       0       -5.0    15.     #log_ro/msy 
0.3        0.2     1.0      4       3       3       2       #steepness/fmsy
-2      -5.0    0.0      2       1       -1.469  0.05    #log.m
...
3.5	3.5	3.5	9.9	3.5	3.5	3.5	3.5 	# 2  -Age/length at 50% selectivity (logistic)
1	1	1	0.00011	1	1	1	1 	# 3  -STD at 50% selectivity (logistic)
5	5	5	0	5	5	5	5 	# 4  -No. of age nodes for each gear (0=ignore)
...
## ------------------------------------------------------------------------- ##
	...
	1000	# 3  -std in observed catches in first phase.
	500	# 4  -std in observed catches in last phase.
